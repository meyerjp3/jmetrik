...
public interface DatabaseAccessObject {
    ...
    /**
     * Creates an ArrayList of VariableInfo objects from the values in the specified column.
     ...
     * @param variableName name of column to use for VariableInfo data
     * @return
     * @throws SQLException
     */
    ...
    public void addColumnToDb(Connection conn, DataTableName tableName, VariableInfo variableInfo)throws SQLException;
    ...
    public void setVariableScoring(Connection conn, VariableTableName tableName, ArrayList<VariableInfo> variables)throws SQLException;

    public void setVariableScoring(Connection conn, ScoringCommand command)throws SQLException;

    public void setVariableGrouping(Connection conn, VariableTableName tableName, ArrayList<VariableInfo> variables)throws SQLException;

    public void setOmitCode(Connection conn, VariableTableName tableName, ArrayList<VariableInfo> variables)throws SQLException;

    public void setNotReachedCode(Connection conn, VariableTableName tableName, ArrayList<VariableInfo> variables)throws SQLException;

    public void setOmitAndNotReachedCode(Connection conn, VariableTableName tableName, ArrayList<VariableInfo> variables)throws SQLException;

    public void saveVariables(Connection conn, VariableTableName tableName, ArrayList<VariableInfo> variables)throws SQLException;
