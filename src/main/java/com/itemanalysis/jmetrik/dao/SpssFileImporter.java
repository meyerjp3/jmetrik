 ...
 *
 * On Linux and UNIX:
 * spssjavaplugin.jar is located in the bin directory under the IBM SPSS Statistics installation directory
 *
 * Requirements:
...
public class SpssFileImporter extends SwingWorker<String,Void> {
    ...
    private void parseCommand(){
        ...
        String pathToPlugin = command.getFreeOption("path").getString();
