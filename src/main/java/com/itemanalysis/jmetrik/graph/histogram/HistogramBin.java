 ...
 *
 * 09-Sep-2009 : added weighted incrmeent: public void incrementCount(int frequency). J. Patrick Meyer
 *
 */
...
/**
 * A bin for the {@link HistogramChartDataset} class.
 */
public class HistogramBin implements Cloneable, Serializable {
    ...
    /**
     *
     * @param frequency size of increment
     */
    public void incrementCount(int frequency){
