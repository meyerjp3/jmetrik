...
//    }
    ...
    public LinkedHashMap<VariableName, ItemResponseModel> getFormXItemParameters(Connection conn, DataTableName tableName,
                                                                           ArrayList<LinkingItemPair> commonItems,
                                                                           boolean logisticScale) throws SQLException{
        return getItemParameters(conn, tableName, commonItems, true, logisticScale);
    }

    public LinkedHashMap<VariableName, ItemResponseModel> getFormYItemParameters(Connection conn, DataTableName tableName,
                                                                           ArrayList<LinkingItemPair> commonItems,
                                                                           boolean logisticScale) throws SQLException{
        return getItemParameters(conn, tableName, commonItems, false, logisticScale);
    }

    private LinkedHashMap<VariableName, ItemResponseModel> getItemParameters(Connection conn, DataTableName tableName,
                                                                       ArrayList<LinkingItemPair> commonItems, boolean formX,
                                                                       boolean logisticScale) throws SQLException{

        LinkedHashMap<VariableName, ItemResponseModel> irmSet = new LinkedHashMap<VariableName, ItemResponseModel>();
     ...
     * @throws SQLException
     */
    public LinkedHashMap<VariableName, ItemResponseModel> getItemParameters(Connection conn, DataTableName tableName,
