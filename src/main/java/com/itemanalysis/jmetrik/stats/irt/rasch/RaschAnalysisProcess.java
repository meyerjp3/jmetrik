...
public class RaschAnalysisProcess extends AbstractJmetrikProcess {

    private final String PROCESS_NAME = "Rasch Analysis Process";

    private RaschCommand command = null;

    public RaschAnalysisProcess(){
    ...
    public void setCommand(Command command){
        this.command = (RaschCommand)command;
    }
    ...
    public void addMenuItem(final JFrame parent, JMenu menu, final TreeMap<String, JDialog> dialogs, final Workspace workspace, final JList tableList){
        ...
        JMenuItem menuItem = new JMenuItem("Rasch Models (JMLE)...");
        menuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!workspace.databaseOpened()){
                    ...
                    RaschDialog raschAnalysisDialog = (RaschDialog)dialogs.get(PROCESS_NAME);
                    if(raschAnalysisDialog==null){
                        raschAnalysisDialog = new RaschDialog(parent,
                        ...
                        dialogs.put(PROCESS_NAME, raschAnalysisDialog);
                        workspace.addVariableChangeListener(raschAnalysisDialog.getVariableChangedListener());
                    }
                    raschAnalysisDialog.setVisible(true);

                    if(raschAnalysisDialog.canRun()){
                        workspace.runProcess(raschAnalysisDialog.getCommand());
                    }
                }
            }
        });
    ...
    public void runProcess(Connection conn, JmetrikDatabaseFactory dbFactory, final JTabbedPane tabbedPane, ThreadPoolExecutor threadPool){
        ...
        JmetrikTab jTab = new JmetrikTab("rasch"+ tabCount);
        ...
        RaschAnalysis itemAnalysis = new RaschAnalysis(conn, dbFactory.getDatabaseAccessObject(), command, textFile);
