...
public class DeleteVariableCommand extends AbstractCommand {


    public DeleteVariableCommand(){
        super("delvar", "Delete variable command");
        try{
            ...
            FreeOptionList selectedVariables = new FreeOptionList("variables", "Variables to delete", true, OptionValueType.STRING);
