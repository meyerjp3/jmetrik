...
public class SubsetVariableCommand extends AbstractCommand {

    public SubsetVariableCommand()throws IllegalArgumentException{
        super("subvar", "Variable subset command");
        try{
            ...
            FreeOptionList selectedVariables = new FreeOptionList("variables", "Selected variable", true, OptionValueType.STRING);
